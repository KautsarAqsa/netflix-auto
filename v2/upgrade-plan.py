...
chromedriverpath = r'C:\Users\finno\netflix-auto\chromedriver'
...
log_file = open('upgrade_log.txt', 'a')
...
plan_dict_brl = {
    'dasar': '//*[@id="appMountPoint"]/div/div/div[2]/div/div/div[2]/label[1]',
    'standar': '//*[@id="appMountPoint"]/div/div/div[2]/div/div/ul/li[2]',
    'premium': '//*[@id="appMountPoint"]/div/div/div[2]/div/div/div[2]/label[3]/h2',
    }
...
def Upgrade(email_id, password):
    ...
    try:
        try:
            ...
            Click(element = '//*[@id="appMountPoint"]/div/div/div[2]/div/div/div[4]/div/footer/div/button[1]')
            
        time.sleep(3)
    except:
        current = GetText(element = '//*[@id="appMountPoint"]/div/div/div[2]/div/div/div/div[4]/div[2]/section/div/div[1]/div[1]/div/b').split()[-1]
    ...
    try:
        ...
        next_bill_date = GetText(element='//*[@id="appMountPoint"]/div/div/div[2]/div/div/div/div[4]/div[1]/section/div[2]/div/div/div[1]/div[2]')
        Output = '{} : {}'.format(email_id, next_bill_date)
